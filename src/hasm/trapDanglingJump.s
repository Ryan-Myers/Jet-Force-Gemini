...
glabel TrapDanglingJump
    ...
    /* 55D54 80055154 3C088010 */  lui        $t0, %hi(D_800FF78C_10038C)
    /* 55D58 80055158 3C098010 */  lui        $t1, %hi(D_800FF780_100380)
    ...
    /* 55D8C 8005518C 8D08F78C */  lw         $t0, %lo(D_800FF78C_10038C)($t0)
    /* 55D90 80055190 8D29F780 */  lw         $t1, %lo(D_800FF780_100380)($t1)
  .L80055194_55D94:
    /* 55D94 80055194 3C028010 */  lui        $v0, %hi(D_800FF78C_10038C)
    /* 55D98 80055198 8C42F78C */  lw         $v0, %lo(D_800FF78C_10038C)($v0)
  ...
  .L800551DC_55DDC:
    /* 55DDC 800551DC 3C0C8010 */  lui        $t4, %hi(D_800FF790_100390)
    /* 55DE0 800551E0 3C0B8010 */  lui        $t3, %hi(D_800FF784_100384)
    /* 55DE4 800551E4 354A0450 */  ori        $t2, $t2, (0x80000450 & 0xFFFF)
    /* 55DE8 800551E8 8D8CF790 */  lw         $t4, %lo(D_800FF790_100390)($t4)
    /* 55DEC 800551EC 8D6BF784 */  lw         $t3, %lo(D_800FF784_100384)($t3)
  .L800551F0_55DF0:
  ...
  .L800551F8_55DF8:
    ...
    /* 55E10 80055210 3C028010 */  lui        $v0, %hi(D_800FF788_100388)
    /* 55E14 80055214 8C42F788 */  lw         $v0, %lo(D_800FF788_100388)($v0)
    ...
    /* 55E58 80055258 3C038010 */  lui        $v1, %hi(D_800FF780_100380)
    /* 55E5C 8005525C 8C63F780 */  lw         $v1, %lo(D_800FF780_100380)($v1)
