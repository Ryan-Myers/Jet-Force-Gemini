...
u32 D_800A9808_AA408 [6] = {
    0, 0, 0, 0xC1200000, 0, 0
};

#define M_PI    3.141592741f

void func_8008DA00_8E600(f32 outputrate, f32 arg1, f32 arg2, f32 *arg3, f32 *arg4)
{
	f32 sp24;
	f32 sp20;
	f32 sp1c;
...
void n_alFxInitlpfilter_mono(struct fx *fx, f32 outputrate)
{
	...
	func_8008DA00_8E600(outputrate, fx->unk00 + 10.0f, fx->unk02 / 10.0f, sp30, sp24);
