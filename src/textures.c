...
#pragma GLOBAL_ASM("asm/nonmatchings/textures/initColourCycle.s")

#pragma GLOBAL_ASM("asm/nonmatchings/textures/resetColourCycle.s")

#pragma GLOBAL_ASM("asm/nonmatchings/textures/updateColourCycle.s")

#pragma GLOBAL_ASM("asm/nonmatchings/textures/resetMixCycle.s")

#pragma GLOBAL_ASM("asm/nonmatchings/textures/updateMixCycle.s")
